...
$paths = @() ## "paths" var records all file paths to be put in the final zip
get-childitem c:\k\*.log* -Exclude $lockedFiles | Foreach-Object {
  $paths += $_
}
<#
===================Section 1: collect k8s log files under c:\k===================
Generate a new temp folder name and copy files in
#>
...
<#
===================Section 2: collect k8s log files under c:\windows\system32===================
Generate a new temp folder name and copy files in
#>
...
<#
===================Section 3: export etw for system events and hyper-v and dockerd and gMSA===================
Generated files are put under $ENV:TEMP, paths recorded in "paths"
#>
...
<#
===================Section 4: collect HNS logs and CSE logs===================
HNS logs are collected by invoking "collectlogs.ps1" and into a randomly named folder under c:\k\debug
#>
...
<#
===================Section 5: collect container lists from containerd and CRI interface===================
#>
...
<#
===================Section 6: collect containerd config and panic logs and calico logs===================
#>
...
<#
===================Final: Dump all files in "paths" to the result zip file===================
#>
